...
$(function () {
  ...
  const genericOptions = {
    ...
    var intersect = true
    // data bpm
    const databpm = [20,56,70,80,90,43,23,67,80,90,100,20,30,80,50,60,90,32,67,89,67,80,90,65];
...
plugins: [{
  beforeRender: (x, options) => {
    ...
    const datatemp = [29,28,29,28,29,27,30,30,40,20,31,17,18,19,12,23,25,26,26,27,24,25,26,24];
